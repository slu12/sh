<template>
    <div class="box_col">
      ...
      <div class="box_col_auto rowCenter">
        ...
        <div style="text-align: center;margin: 0px 200px">
          <Row v-show="videoList.length>0">
            <Col span="8" v-for="(item,index) in videoList" :key="index" style="height: 400px;">
                <Card style="height: 400px">
                  <h5>{{index+1}}号通道</h5>
                  <ul>
                    <iframe  style="height: 400px;width: 100% ; object-fit: fill" :src="item"></iframe>
                  </ul>
                 <!-- <video
  ...
  export default {
    ...
    methods: {
      ...
      getvideo(){
        ...
        //   }
        // }
        this.$http.post('/api/cl/getAllChn',{mmsi:this.param.mmsi}).then((res)=>{
          if (res.code == 200){
