...
<template>
    <div class="box_col">
        ...
        <Card>
                ...
                <div style="height: 45px;line-height: 45px;">
                    <div class="margin-top-10 box-row">
                        ...
                        <div class="body-r-1 inputSty">
                            <Input v-model="param.cphLike" placeholder='车牌号' style="width: 200px" @on-keyup.enter="findMessList()"></Input>
                            <Input v-model="param.zdbhLike" placeholder='终端号' style="width: 200px" @on-keyup.enter="findMessList()"></Input>
                            <Input v-model="param.sjxmLike" placeholder='司机姓名' style="width: 200px" @on-keyup.enter="findMessList()"></Input>
                        </div>
                        <div class="butevent">
            ...
            <Row v-if="showCard" :gutter="20" v-for="(row,rowIndex) in tableData" :data="row"  :key="rowIndex">
