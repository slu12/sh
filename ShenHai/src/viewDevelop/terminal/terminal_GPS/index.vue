        ...
        <div class="box_row rowBetween colItemCenter boxMar_B">
          ...
          <div class="box_row rowRight">
            <div class="body-r-1 inputSty">
              ...
              <Input v-model="param.zdbhLike" placeholder='TERMINAL_NUM' style="width: 200px"
                     @on-keyup.enter="getPageData()"></Input>
              <Input v-model="param.cphLike" placeholder='CAR_NUMBER' style="width: 200px"
                     @on-keyup.enter="getPageData()"></Input>
    ...
    export default {
        ...
        created() {
            this.$store.commit('setCurrentPath', [{
                ...
                this.tabHeight = this.getWindowHeight() - 200
            this.getPageData()
            this.getLXDic()
        },
        methods: {
