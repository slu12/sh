...
<script>
  export default {
    ...
    methods:{
      ...
      buildPolygon(){
        let pots = [
          new BMap.Point(111.983861,30.293206),
          new BMap.Point(111.999177,30.281785),
          new BMap.Point(112.026571,30.275691),
          new BMap.Point(112.080656,30.28593),
          new BMap.Point(112.217021,30.310205),
          new BMap.Point(112.262423,30.211215),
          new BMap.Point(112.193138,30.152732),
          new BMap.Point(112.193138,30.152732),
          new BMap.Point(112.250629,30.060731),
          new BMap.Point(112.355058,29.967668),
